...
public class GitHubController {
    ...
    public ResponseEntity<?> getContents(
        ...
        try {
            ...
            // We can check if it is a directory by trying to list it.
            // If it fails with "Path is not a directory", then we try to get content.
            // Or we could have an explicit "getType" but let's reuse listFiles.
